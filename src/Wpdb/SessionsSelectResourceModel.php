 ...
 *
 * This implementation includes the resources from the relationship table and groups sessions such that a new column is
 * included that contains a comma separated list of resource IDs.
 *
 * @since [*next-version*]
 */
class SessionsSelectResourceModel extends WpdbSelectResourceModel
{
    /**
    ...
    public function __construct(
        ...
        $fieldColumnMap[static::RESOURCES_COLUMN] = $expBuilder->fn(
            'GROUP_CONCAT',
            [$expBuilder->ef('session_resources', 'resource_id')]
        );
